          ...
          child: Card(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.lock_reset_rounded, size: 56, color: Theme.of(context).colorScheme.primary),
                  const SizedBox(height: 16),
                  Text('Password recovery is not available yet.', style: Theme.of(context).textTheme.titleMedium),
