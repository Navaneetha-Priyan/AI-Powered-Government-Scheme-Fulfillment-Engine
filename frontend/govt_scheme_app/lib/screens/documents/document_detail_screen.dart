...
class _DocumentDetailScreenState extends State<DocumentDetailScreen> {
  ...
  Future<void> _load() async {
    ...
    final currentDocument = provider.selectedDocument;
    if (currentDocument?.id == widget.documentId) {
      return;
    }

    try {
      await provider.loadDocument(widget.documentId);
    } catch (_) {}
  }
        ...
        return Scaffold(
          ...
          body: provider.isLoading && doc == null
              ...
              : doc == null
                  ...
                  : RefreshIndicator(
                      onRefresh: () => provider.loadDocument(widget.documentId),
                      child: ListView(
                        ...
                        children: [
                          ...
                          InfoCard(
                            ...
                            value: doc.downloadUrl != null && doc.downloadUrl!.isNotEmpty
                                ? 'Preview information is available through the linked source.'
                                : 'No preview/source link is currently available.',
                          ...
                          InfoCard(
                            label: 'Created At',
                            value: AppFormatters.displayDateTime(doc.createdAt),
